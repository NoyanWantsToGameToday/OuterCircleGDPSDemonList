...
export default {
    ...
    template: `
        <div class="tier" style="height: 100%; justify-content: center; align-items: center;">
            ...
            <p style="padding-top:1.5rem">The levels {{ descending ? 'below' : 'above' }} are {{ ["beginner", "easy", "medium", "hard", "insane", "easy demon", "medium demon", "hard demon", "insane demon", "extreme demon", "silent demon", "impossible demon"][level.difficulty] }} Levels.</p>
