...
export default {
    ...
    template: `
        <div class="level">
            ...
            <h3>Difficulty: {{["Beginner", "Easy", "Medium", "Hard", "Insane", "Easy Demon", "Medium Demon", "Hard Demon", "Insane Demon", "Extreme Demon", "Silent Demon", "Impossible Demon"][level.difficulty]}} Level</h3>
