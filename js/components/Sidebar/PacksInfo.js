export default {
    template: `
        ...
        <div class="right-text">
            <p>Packs are sets of levels on the Outer Circle List chosen by the staff team that share distinct commonalities and are within a close difficulty range (generally ± 1 difficulty tier).</p>
