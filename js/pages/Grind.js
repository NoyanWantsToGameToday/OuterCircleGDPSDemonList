                                    ...
                                    <div class="meta">
                                        <div>
                                            <div class="rank-container">
                                                <p>#{{ level.rank }} - {{["Beginner", "Easy", "Medium", "Hard", "Insane", "Mythical", "Extreme", "Supreme", "Ethereal", "Legendary", "Silent", "Impossible"][level.difficulty]}} Demon</p>
                                            </div>
                                        ...
                                        <h2><a class="director" :href="'https://outercirclegdpsdemonlist.pages.dev/#/level/' + level.path" target="_blank">{{ level.name }}</a></h2>
                                        <div>
